...
## Run Pseudomonas Analysis

## SET SIZE AND DISTRIBUTION ANALYSIS
...
# plot comparison of set size distributions
...
# draw_heatmap_g0(656, 509, g0, gr0, C = C)
draw_heatmap_g0(654, 109, g0, gr0, C = C)

## EXPRESSION FITNESS ANALYSIS
